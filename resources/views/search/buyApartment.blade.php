    ...
    <div class="search-head ">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9">
            <form class="form-inline justify-content-center my-2 my-lg-0 " role="search" action="{{route('buyApartment')}}" method="GET" style="text-align: center;">
    ...
    <aside class="col-lg-8 search-result">
      ...
      <div class="card" style="width: 100%;">
        <div class="card-header">
          {{$product->flat}}BHK {{$product->type}} in {{$product->locality}}, {{$product->city}}
