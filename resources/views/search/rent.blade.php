    ...
    <div class="search-head ">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9">
            <form class="form-inline justify-content-center my-2 my-lg-0 " role="search" action="{{route('rent')}}" method="GET" style="text-align: center;">
  ...
  <div class="row">
    ...
    <aside class="col-lg-8 search-result">
      ...
      <div class="search-result">
        <span>{{$products->count()}} properties | All Residential for Rent in '{{ request()->input('query')}}'</span>
      </div>
