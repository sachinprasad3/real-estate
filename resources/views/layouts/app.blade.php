...
<head>
    ...
    <link href="{{ asset('css/sidebarNavigation.css') }}" rel="stylesheet">
</head>
<body>
    <div id="app">
        <nav class="navbar navbar-default navbar-static-top  sidebarNavigation" data-sidebarClass="navbar-static-top">
            <div class="container">
