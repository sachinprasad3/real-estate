      ...
      <div class="form-group">
        ...
        <div class="form-check">
            <div class="row">
              ...
              <div class="col-4">
                <input class="form-check-input" type="checkbox" name="flat[]" value="1BHK">
                <label class="form-check-label">1BHK</label>
              </div>
              <div class="col-4">
                <input class="form-check-input" type="checkbox" name="flat[]" value="2BHK">
                <label class="form-check-label">2BHK</label>
              </div>
              <div class="col-4">
                <input class="form-check-input" type="checkbox" name="flat[]" value="3BHK">
                <label class="form-check-label">3BHK</label>
              </div>
              <div class="col-4">
                <input class="form-check-input" type="checkbox" name="flat[]" value="5BHK">
                <label class="form-check-label">5BHK</label>
              </div>
              <div class="col-4">
                <input class="form-check-input" type="checkbox" name="flat[]" value="7BHK">
